#############################################################################
# This R script annotates the identifiers of species and life stages        #
# associated with the SO-CPR dataset with taxonomical hierarchy using       #
# the worrms package and regex.                                             #
#############################################################################
...
# Add rows of ID's that are horribly picked to automate the process
